...
bot.on('message', message => {
    if (message.content.startsWith(prefix + "Combats 1")) {
        const embed = new Discord.RichEmbed()
            .setAuthor(message.author.username, message.author.avatarURL)
            .setFooter("『LastHour [RP/ERP/MMO]』©", "http://www.copyrightfrance.com/images/copyright.png")
            .setColor(10038562)
...
bot.on('message', message => {
    if (message.content.startsWith(prefix + "Combats 2")) {
        const embed = new Discord.RichEmbed()
            .setAuthor(message.author.username, message.author.avatarURL)
            .setFooter("『LastHour [RP/ERP/MMO]』©", "http://www.copyrightfrance.com/images/copyright.png")
            .setColor(10038562)
...
bot.on('message', message => {
    if (message.content.startsWith(prefix + "Récolte")) {
        const embed = new Discord.RichEmbed()
            ...
            .setFooter("『LastHour [RP/ERP/MMO]』©", "http://www.copyrightfrance.com/images/copyright.png")
            .setColor(10038562)
            .addField("Système de récolte :", "Comme le système de fouille, vous pourrez à la place passer votre temps dans une zone à récolter des ressources comme par exemple du bois, des minerais, des fibres, du poissons, du cuir, de la viande d'animaux et d'autres possibilités encore selon la zone !\n\nLes commandes concernant la fouille sont à faire dans #〘≡〙récolte.\n\nIl est possible qu'en étant dans une zone, de RP avec un autre joueur/PNJ et d'effectuer votre récolte.\n\nIl vous faut les bon outils selon la zones pour pouvoir récolter les ressources.\n\nVous ne pouvez faire plus de 6 H de fouille/récolte/combat confondus à l'extérieur par jour (reset à partir de 00 h) car votre personnage sera épuisé et devra retourner en ville.\n\nPour chaques heures où votre personnage récolte dans une zone, il faudra faire la commande en question selon le nombre d'heures, par exemple si vous avez pêcher dans `Landgrave` 6 H de suite, vous allez devoir faire 6 fois dans #〘≡〙récolte au final :\n`=Landgrave pêcheur`")
