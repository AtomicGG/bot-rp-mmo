...
bot.on('message', message => {
    if (message.content.startsWith(prefix + "Viande de renard")) {
        const embed = new Discord.RichEmbed()
            ...
            .setFooter("『LastHour [RP/ERP/MMO]』©", "http://www.copyrightfrance.com/images/copyright.png")
            .setColor(10038562)
            .addField("Information :", "Une fois cuite, cette viande à sa consommation comblera votre faim !\n\n\n`Viande de renard (+)(cuite)` : 1 Rang de faim en moins\n`Viande de renard (++)(cuite)` : 1 Rang de faim en moins / Bonus de 3 sur le physique durant 24 H\n`Viande de renard (+++)(cuite)` : 2 Rangs de faim en moins / Bonus de 3 sur le physique")
...
bot.on('message', message => {
    if (message.content.startsWith(prefix + "Viande de crapaud")) {
        const embed = new Discord.RichEmbed()
            ...
            .setFooter("『LastHour [RP/ERP/MMO]』©", "http://www.copyrightfrance.com/images/copyright.png")
            .setColor(10038562)
            .addField("Information :", "Une fois cuite, cette viande à sa consommation comblera votre faim !\n\n\n`Viande de renard (+)(cuite)` : 1 Rang de faim en moins\n`Viande de renard (++)(cuite)` : 1 Rang de faim en moins / Bonus de 2 sur le physique durant 24 H\n`Viande de renard (+++)(cuite)` : 2 Rangs de faim en moins / Bonus de 3 sur le physique")
            .addField("Fabrication :", "Vous devez la cuire si elle est cru pour la manger grâce à du feu, comme par exemple dans la cuisine de la ville, ou à l'auberge...")
            .setTimestamp()
        message.channel.send({ embed })
    }
